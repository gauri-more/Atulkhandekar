                    ...
                    <div class="container container">
                        <div class="contact-top">
                            <div class="section-title text-center">
                                <span class="sub-title  justify-content-center"><img src="assets/img/sub-title-1.svg" alt="img">Contact Us</span>
                                <h2 class="">Get In Touch With Atul Khandekar</h2>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="icon-box-items-inners">
                                        ...
                                        <div class="content">
                                            <p>Call Us</p>
                                            <h3 class="title"><a href="tel:+919922442438">+919922442438</a></h3>
                                            <p class="mt-2">Landline: <a href="tel:+912024537414">(020)24537414</a></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="contact-middle-items">
                            <div class="row g-4">
                                <div class="col-lg-6 wow fadeInUp">
                                    <form action="mail-handler.php" method="POST" id="contact-form" class="contact-form-box">
